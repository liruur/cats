<?php
						$flow_hash = "14f69b71e2d85f9ba7e0e4e1e53fb498";
						$data["referer"] = "NULL";
						$data["user_agent"] = "NULL";
						$data["utm"] = "NULL";
						$data["langs"] = "NULL";
						$data["ip"] = "NULL";					
						$data["url"] = "https://naisesate.ru/px8pKk?utm_term={keyword}&utm_creative={creative}&utm_campaign={campaignid}&utm_position={adposition}&utm_network={network}&utm_target={target}&utm_placement={placement}&utm_match={matchtype}";
